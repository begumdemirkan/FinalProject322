...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject322.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FinalProject322.Models.Kupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("FinalProject322.Models.ShoppingCart", b =>
                {
                    ...
                    b.Property<int?>("OrderDetailsCardId");
            ...
            modelBuilder.Entity("FinalProject322.Models.ShoppingCart", b =>
                {
                    b.HasOne("FinalProject322.Models.OrderDetailsCard")
                        .WithMany("listCart")
                        .HasForeignKey("OrderDetailsCardId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FinalProject322.Models.Userr")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
